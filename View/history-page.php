   ...
   <body id="page-top">
      ...
      <div id="wrapper">
         ...
         <?php foreach ($theHistory as $a): ?>
             <div class="col-xl-3 col-sm-6 mb-3">
                 <div class="video-card history-video">
                     <div class="video-card-image"  onclick="goToVideoPage('<?= $a['video']->getID(); ?>', '<?php echo $a['history']->getUserID(); ?>')">
                         <a onclick="triggerWowFunction('<?= $a['history']->getUserID(); ?>', '<?php echo $a['video']->getID(); ?>')" class="video-close" href="#"><i class="fas fa-times-circle"></i></a> </button>
                         <a class="play-icon" href="#"><i class="fas fa-play-circle"></i></a>
                         <a href="#"><img class="img-fluid" src="<?php echo $a['video']->getThumbnail(); ?>" alt=""></a>
                         <div class="time">3 </div>
                     </div>
