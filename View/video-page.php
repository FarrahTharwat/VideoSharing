...
if ($result && $result->num_rows > 0) {
    // Fetch the row from the result set and store the value of the 'Name' column in a variable
                ...
                <div class="col-md-8">
                        ...
                        <div class="video-player">
                            ...
                            <div class="player-controls">
                                ...
                                <div class="inner-player-controls">
                                    ...
                                    <button id="fullscreen-button" class="control-button" onclick="toggleFullscreen()" style="margin-left:215px">
                    ...
                    <div class="single-video-title boxx mb-3">
                        <div class="single-video-author boxx mb-3" style="margin-bottom:-50%;">
                            ...
                            <p><a href="#"><strong><?php echo $Name ?></strong></a> <span title="" data-placement="top"
                                                                                     data-toggle="tooltip" data-original-title="Verified"><i
                                            class="fas fa-check-circle text-success"></i></span></p>
                            <small>Published on <?php echo $VideoAttribute->getDate(); ?></small>
                        </div>
                  ...
                  <div class="video-player">
                     ...
                     <div class="player-controls">
                        ...
                        <div class="inner-player-controls">
                           ...
                           <button class="control-button">
                              <img src="img/settings.png" style="margin-top:5px ;">
                              <select class="control-button" id="quality" style="color: white;">
