...
=======
                <div class="row">
                    <div class="col-md-8">
                        <div class="single-video-left">
                            <div class="video-player">
                                <video class="video" width="100%" height="315" id="my-video" src=<?php echo "$video1" ?> frameborder="0" autoplay encrypted-media allowfullscreen></video>

                                <div class="player-controls">
                                    <div class="video-progress" id="progress-bar">
                                        <div class="video-progress-filled"id="progress-bar"></div>
                                    </div>

                                    <div class="inner-player-controls">
                                        <button class="play-button" title="Play" id="play-pause-button" style="font-size:large;">►</button>

                                        <button class="mute control-button" id="mute-button">
                                            <div class="mute muted slash"></div>
                                            <img src="img/volume.png"></img>
                                        </button>
                                        <input type="range" class="volume" min="0" max="1" step="0.01" value="1" id="volume-bar" />

                                        <div class="time">
                                            <span id ="current-time"class="current">0:00</span> / <span id="duration">0:00</span>
                                        </div>
>>>>>>> Stashed changes
...
=======
                                        <button class="control-button">
                                            ...
                                            <select id="quality-select"class="control-button" style="color: white;">
                                                <option value="360p" style="color: black;">360p</option>
...
<script src="js/toggleReact.js"></script>
